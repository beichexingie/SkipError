...
def transform_entity2json(input_file):
	...
	f_input = open(input_file,encoding="utf-8")
	f_json = open(dirname + "/" + out_name + ".json","w",encoding="utf-8")
	f_val = open(dirname + "/" + out_name + "_val.txt","w",encoding="utf-8")
...
if __name__ == '__main__':
	...
	transform_entity2json("code\data\Person.txt")